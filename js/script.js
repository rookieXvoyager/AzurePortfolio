...
const animateOnScroll = document.querySelectorAll(
    '.about-text, .stat, .timeline-item, .skill-category, ' +
    '.experience-card, .project-card, .cert-item, .profile-card, ' +
    '.honor-item, .contact-item, .contact-form'
);
...
window.addEventListener('load', () => {
    ...
    if (footer) {
        ...
        footer.textContent = `© ${currentYear} Sohan Dhanki. All rights reserved.`;
    }
});
...
window.addEventListener('scroll', debounce(highlightNavLink, 20));

// ========================================
// CONSOLE MESSAGE (Optional Easter Egg)
// ========================================

console.log('%c👨‍💻 Sohan Dhanki | Portfolio', 'color: #2563eb; font-size: 20px; font-weight: bold;');
console.log('%cInterested in the code? Check out my GitHub: https://github.com/rookieXvoyager', 'color: #10b981; font-size: 14px;');
console.log('%cBuilt with ❤️ using HTML, CSS, and Vanilla JavaScript', 'color: #6b7280; font-size: 12px;');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add custom cursor effect on project cards (optional)
